        ...
        addKeyListener(new KeyAdapter() { // new KeyAdapter() { ... } est une instance de classe anonyme, il s'agit d'un objet qui correspond au controleur dans MVC
            ...
            public void keyPressed(KeyEvent e) {
                switch(e.getKeyCode()) {  // on regarde quelle touche a été pressée
                    ...
                    case KeyEvent.VK_A : ColonneDeplacement.getInstance().setDirectionCourante(Direction.haut); break;
                    case KeyEvent.VK_Z : ColonneDeplacement.getInstance().setDirectionCourante(Direction.bas); break;
...
//        icoHero = chargerIcone("Images/hero.png", 0, 0, 35, 40);//chargerIcone("Images/Pacman.png");
    ...
    private void placerLesComposantsGraphiques() {
        setTitle("Gyromite");
        setSize(400, 250); // default 400,250
